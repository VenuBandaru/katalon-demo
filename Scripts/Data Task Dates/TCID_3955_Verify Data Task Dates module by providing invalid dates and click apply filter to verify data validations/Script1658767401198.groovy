...
WebUI.sendKeys(findTestObject('14. Data Task Dates/Textbox_EstDelivFrom'), Keys.chord(Keys.DELETE))
...
WebUI.sendKeys(findTestObject('14. Data Task Dates/Textbox_EstDelivTo'), Keys.chord(Keys.DELETE))
