...
WebUI.verifyElementPresent(findTestObject('14. Data Task Dates/Textbox_EstDelivFrom'), 25)

WebUI.sendKeys(findTestObject('14. Data Task Dates/Textbox_EstDelivFrom'), Keys.chord(Keys.CONTROL, 'A'))

WebUI.sendKeys(findTestObject('14. Data Task Dates/Textbox_EstDelivFrom'), '07/16/2023')
...
WebUI.sendKeys(findTestObject('14. Data Task Dates/Textbox_EstDelivTo'), '08/13/2023')
...
WebUI.waitForElementPresent(findTestObject('14. Data Task Dates/Textbox_TaskStatus'), 20)

WebUI.sendKeys(findTestObject('14. Data Task Dates/Textbox_TaskStatus'), '[All Closed]')

WebUI.sendKeys(findTestObject('14. Data Task Dates/Textbox_TaskStatus'), Keys.chord(Keys.ENTER))
...
WebUI.verifyElementPresent(findTestObject('14. Data Task Dates/ResultsPerPage'), 60)
...
WebUI.verifyElementText(findTestObject('14. Data Task Dates/Status_ProcessingComplete'), 'Processing Complete')

WebUI.verifyElementPresent(findTestObject('14. Data Task Dates/Grid_Pagination_One'), 10)

WebUI.waitForElementPresent(findTestObject('14. Data Task Dates/Textbox_TaskStatus'), 20)

WebUI.sendKeys(findTestObject('14. Data Task Dates/Textbox_TaskStatus'), Keys.chord(Keys.CONTROL, 'A'))

WebUI.sendKeys(findTestObject('14. Data Task Dates/Textbox_TaskStatus'), '[All Open]')
...
WebUI.verifyElementPresent(findTestObject('14. Data Task Dates/GridSection_btn_Calendar'), 10)
...
WebUI.verifyElementText(findTestObject('14. Data Task Dates/Status_Follow-up_On_Avalibility'), 'Determine Alternate Collection Method')
