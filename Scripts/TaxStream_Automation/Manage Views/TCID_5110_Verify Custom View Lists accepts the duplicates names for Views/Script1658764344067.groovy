...
WebUI.sendKeys(findTestObject('Manage Views/textbox_ViewName'), 'Updated Test_View1')
...
WebUI.waitForElementPresent(findTestObject('Manage Views/Duplicate_Name'), 30)

WebUI.verifyElementPresent(findTestObject('Manage Views/btn_CANCEL'), 30)

WebUI.click(findTestObject('Manage Views/btn_CANCEL'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('Manage Views/Duplicate_Name'), 30)

WebUI.waitForElementPresent(findTestObject('Manage Views/ColumnHeading_ViewName'), 30)

WebUI.verifyElementPresent(findTestObject('Manage Views/Updated Test_View1'), 30)
...
WebUI.verifyElementPresent(findTestObject('Manage Views/Delete_header_Updated_Test_View1'), 30)

WebUI.verifyElementPresent(findTestObject('Manage Views/Updated_Description'), 30)
