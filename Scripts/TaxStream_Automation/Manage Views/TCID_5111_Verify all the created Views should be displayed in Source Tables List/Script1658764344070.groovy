...
WebUI.sendKeys(findTestObject('Manage Views/textbox_Query'), 'Updated Test Query1')
...
WebUI.waitForElementPresent(findTestObject('Manage Views/heading_Views'), 30)

WebUI.waitForElementPresent(findTestObject('Manage Views/LoaderConfig'), 30)

WebUI.click(findTestObject('Manage Views/LoaderConfig'))

WebUI.waitForElementPresent(findTestObject('Loader Config Page/ViewVersions'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/RunTest'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/Plus Add'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/LoaderConfigListings'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/Loader Config'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/LoaderConfig_heading'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/Col_FullyConfigured'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/Col_TargetTable'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/Gear_Configure'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/Bin_Delete'), 10)

WebUI.click(findTestObject('Loader Config Page/Gear_Configure'))

WebUI.waitForElementPresent(findTestObject('Loader Config Page/TAB_Source Tables'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/TAB_Column Mappings'), 10)

WebUI.click(findTestObject('Loader Config Page/TAB_Column Mappings'))

WebUI.click(findTestObject('Loader Config Page/TAB_Source Tables'))

WebUI.waitForElementPresent(findTestObject('Loader Config Page/heading_SourceTableGrid'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/SourceGrid_Output'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/SourceGrid_AddTAble'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/SourceGrid_Col_Output'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/SourceGrid_Col_Table'), 10)

WebUI.waitForElementPresent(findTestObject('Loader Config Page/SourceGrid_Col_Alias'), 10)

WebUI.click(findTestObject('Loader Config Page/SourceGrid_AddTAble'))

WebUI.waitForElementPresent(findTestObject('Manage Views/Select_Checkbox_View'), 10)

WebUI.check(findTestObject('Manage Views/Select_Checkbox_View'))

WebUI.waitForElementPresent(findTestObject('Manage Views/btn_CANCEL'), 10)

WebUI.click(findTestObject('Manage Views/btn_CANCEL'))

WebUI.waitForElementPresent(findTestObject('Manage Views/LoaderConfig'), 30)

WebUI.click(findTestObject('Manage Views/LoaderConfig'))

WebUI.waitForElementVisible(findTestObject('Manage Views/btn_ManageViews'), 30)
