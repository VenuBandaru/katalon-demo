...
WebUI.sendKeys(findTestObject('Manage Views/textbox_ViewName'), Keys.chord(Keys.CONTROL, 'A', Keys.DELETE))
...
WebUI.sendKeys(findTestObject('Manage Views/textbox_Query'), Keys.chord(Keys.CONTROL, 'A', Keys.DELETE))
...
WebUI.click(findTestObject('Manage Views/btn_Edit'))

WebUI.verifyElementPresent(findTestObject('Manage Views/heading_Edit_Custom_View'), 30)

WebUI.verifyElementPresent(findTestObject('Manage Views/btn_CANCEL'), 30)

WebUI.verifyElementPresent(findTestObject('Manage Views/btn_Update'), 30)
