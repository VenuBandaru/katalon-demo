...
WebUI.verifyElementPresent(findTestObject('Manage Views/btn_ManageViews'), 20)

WebUI.verifyElementText(findTestObject('Manage Views/btn_ManageViews'), ManageViews)
