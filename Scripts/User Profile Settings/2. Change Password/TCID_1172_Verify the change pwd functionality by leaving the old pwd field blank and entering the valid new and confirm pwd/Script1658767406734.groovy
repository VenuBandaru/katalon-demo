...
WebUI.sendKeys(findTestObject('3. User Profile Settings/Textbox_oldpassword'), '')

WebUI.sendKeys(findTestObject('3. User Profile Settings/textbox_newpassword'), 'Admin@2021')

WebUI.sendKeys(findTestObject('3. User Profile Settings/textbox_newpasswordconformation'), 'Admin@2021')

WebUI.verifyElementPresent(findTestObject('3. User Profile Settings/btn_ChangePassword'), 10)

WebUI.click(findTestObject('3. User Profile Settings/btn_ChangePassword'))

WebUI.waitForElementPresent(findTestObject('3. User Profile Settings/ErrorMessage_Oldpassword'), 10)
