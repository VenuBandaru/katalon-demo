...
if (result) {
    WebUI.sendKeys(findTestObject('1. Login Page/Username_Textbox'), GlobalVariable.UserName)

    WebUI.setEncryptedText(findTestObject('1. Login Page/Password_Textbox'), GlobalVariable.EncryptedPassword)
    ...
    WebUI.waitForElementPresent(findTestObject('1. Login Page/Dashboard Module'), 10)
}
