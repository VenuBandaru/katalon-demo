...
WebUI.sendKeys(findTestObject('1. Login Page/Password_Textbox'), 'invalid@123')

WebUI.click(findTestObject('1. Login Page/Login_Button'))

WebUI.waitForElementPresent(findTestObject('1. Login Page/Username_ValidationMessage'), 10)
