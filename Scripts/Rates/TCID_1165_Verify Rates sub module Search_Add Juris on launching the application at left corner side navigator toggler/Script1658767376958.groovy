...
WebUI.verifyElementPresent(findTestObject('10. Rates/Sub_Search_Add_Juris'), 10)

WebUI.click(findTestObject('10. Rates/Sub_Search_Add_Juris'))

WebUI.verifyElementPresent(findTestObject('10. Rates/Sec_JurisSearch'), 10)
