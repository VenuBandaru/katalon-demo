...
WebUI.verifyElementPresent(findTestObject('10. Rates/Sub_ByJuris'), 10)

WebUI.click(findTestObject('10. Rates/Sub_ByJuris'))

WebUI.verifyElementPresent(findTestObject('10. Rates/Sec_RatesByJuris_Heading'), 10)
