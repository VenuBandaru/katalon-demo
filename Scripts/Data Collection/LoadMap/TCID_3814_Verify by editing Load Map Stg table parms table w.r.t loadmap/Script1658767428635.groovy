...
WebUI.selectOptionByValue(findTestObject('7. Data Collection/SourceType_Textbox'), '1', false)
...
WebUI.click(findTestObject('7. Data Collection/Editing_TableParam_btn_Close'))
