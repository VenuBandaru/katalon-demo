...
WebUI.verifyElementPresent(findTestObject('7. Data Collection/Grid_StateLabel'), 10)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Grid_State_Textbox'), 10)

WebUI.click(findTestObject('7. Data Collection/Grid_State_Textbox'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('7. Data Collection/Grid_State_Textbox'), Keys.chord(Keys.CONTROL, 'A'))

WebUI.sendKeys(findTestObject('7. Data Collection/Grid_State_Textbox'), 'NV')

WebUI.sendKeys(findTestObject('7. Data Collection/Grid_State_Textbox'), Keys.chord(Keys.ENTER))
