...
WebUI.click(findTestObject('7. Data Collection/Stg_Table_Name_Rec1_Link'))

not_run: WebUI.delay(5)

not_run: WebUI.navigateToUrl('https://sideways-test.ptxtech.com/sourcetemp/loadmap/assrlookup?load_map_id=3&stg_table_name=stg_tx_dallas_abatement_exempt')

WebUI.verifyElementPresent(findTestObject('7. Data Collection/SecHeading_Assessor_Lookup_Heading'), 10)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Sync_button'), 10)

not_run: WebUI.verifyElementPresent(findTestObject('7. Data Collection/Section_Assessor_Lookup_Type'), 10)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/ALT_Col_Description'), 10)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/ALT_Col_Default_Code'), 10)

not_run: WebUI.closeBrowser()

WebUI.navigateToUrl('https://sideways-test.ptxtech.com/sourcetemp/loadmap')
