...
'Load Map Setup\r\nUsers can either create a new load map or use the existing load map and update the configuration to\r\nallow auto-validation. Please consult with the product team for best practices.\r\nNote that the user has to click "save all"to reflect the changes in DB (except for the sync functionality in\r\nLoad Map Stg Table column)\r\nAfter the user confirms that everything is set up correctly, user wants to select the "Verify Enabled"to\r\nenable this load map to be used in auto-validation\r'
WebUI.verifyElementPresent(findTestObject('7. Data Collection/link_TestSourceTemplate'), 15)

WebUI.click(findTestObject('7. Data Collection/link_TestSourceTemplate'))

not_run: WebUI.verifyElementPresent(findTestObject('7. Data Collection/TestLoadMap'), 10)

WebUI.switchToWindowIndex(1)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/table_stg_ga_test_1'), 20)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/table_stg_ga_test_2'), 20)

WebUI.click(findTestObject('7. Data Collection/table_stg_ga_test_1'))

WebUI.verifyElementPresent(findTestObject('7. Data Collection/EditingSecheading_IdTableName'), 10)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Heading_CustomerSearch'), 10)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Editing_Deletebutton'), 10)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Editing_btn_Submit'), 10)
