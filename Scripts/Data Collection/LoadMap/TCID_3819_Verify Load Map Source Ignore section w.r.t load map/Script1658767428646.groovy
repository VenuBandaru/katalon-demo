...
WebUI.verifyElementPresent(findTestObject('7. Data Collection/Secheading_LoadMapSourceIgnore'), 15)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/heading_IgnoreFileRegex'), 15)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/LoadMapSourceIgnore_btn'), 15)

WebUI.click(findTestObject('7. Data Collection/LoadMapSourceIgnore_btn'))

WebUI.verifyElementPresent(findTestObject('7. Data Collection/heading_Adding_IgnoreFileRegex'), 15)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/IgnoreFile_Searchbox'), 15)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/subheading_RegexTester'), 15)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/RegexTester_btn_Cancel'), 15)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/RegexTester_btn_Submit'), 15)

WebUI.click(findTestObject('7. Data Collection/Source/RegexTester_btn_Cancel'))
