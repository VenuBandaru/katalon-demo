...
WebUI.verifyElementClickable(findTestObject('7. Data Collection/Sync_button'))

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Section_Assessor_Lookup_Type'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/AssessotLookupConfig_Plusbutton'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/ALC_Label_Description'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/AssessotLookupConfig_Plusbutton'), 15)

WebUI.click(findTestObject('7. Data Collection/AssessotLookupConfig_Plusbutton'))

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Add_ALT_Table_label_Description'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Add_ALT_Table_Label_DefaultCode'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/ALT_LoadMap_Stg_Table_Column_Lookup'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Add_ALT_btn_Submit'), 15)
