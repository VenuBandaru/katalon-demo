...
WebUI.verifyElementClickable(findTestObject('7. Data Collection/Checkbox_VerifyEnabled'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementPresent(findTestObject('7. Data Collection/SecHeading_SourceTemplateLoadMap'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/btn_SourceTemplateLoadMap'), 15)

WebUI.click(findTestObject('7. Data Collection/btn_SourceTemplateLoadMap'))

WebUI.waitForElementPresent(findTestObject('7. Data Collection/label_SourceTemplate'), 15)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Textbox_SourceTemplate'), 20)

WebUI.sendKeys(findTestObject('7. Data Collection/Textbox_SourceTemplate'), Keys.chord(Keys.CONTROL, 'A'))

WebUI.sendKeys(findTestObject('7. Data Collection/Textbox_SourceTemplate'), 'Report Format (Texas)')

WebUI.sendKeys(findTestObject('7. Data Collection/Textbox_SourceTemplate'), Keys.chord(Keys.ENTER))

WebUI.waitForElementPresent(findTestObject('7. Data Collection/btnSubmit_AddSourceTemplate'), 30, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('7. Data Collection/btnSubmit_AddSourceTemplate'))

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Stg_Table_Name_Rec1_Link'), 10)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/btnDelete_SourceTemplateLoadMap'), 15)

WebUI.click(findTestObject('7. Data Collection/btnDelete_SourceTemplateLoadMap'))

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Label_Year_COlumn'), 15)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Label_Prior_Check'), 15)
