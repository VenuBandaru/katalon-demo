...
WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/CopyTables_Submit_btn'), 10)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/CopyTables_Cancel_btn'), 10)

WebUI.click(findTestObject('7. Data Collection/Source/CopyTables_Submit_btn'))

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/CopyTables_ErrorMessage'), 0)
