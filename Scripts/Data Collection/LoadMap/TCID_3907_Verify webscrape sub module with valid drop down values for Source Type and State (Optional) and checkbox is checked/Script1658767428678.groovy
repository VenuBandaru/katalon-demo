...
WebUI.waitForElementPresent(findTestObject('7. Data Collection/Sub_WebScrape'), 15)

WebUI.click(findTestObject('7. Data Collection/Sub_WebScrape'))

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Sec_WebscrapeList_Heading'), 10)
...
WebUI.click(findTestObject('7. Data Collection/WebScrape_SourceType_ddl'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('7. Data Collection/WebScrape_State(Optional)'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementClickable(findTestObject('7. Data Collection/WebScrape_Checkbox'))
...
WebUI.verifyElementPresent(findTestObject('7. Data Collection/WebScrape_Grid_State_Column'), 10)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/WebScrape_Grid_Enity_Textbox'), 10)

WebUI.sendKeys(findTestObject('7. Data Collection/WebScrape_Grid_Enity_Textbox'), Keys.chord(Keys.CONTROL, 'A'))

WebUI.sendKeys(findTestObject('7. Data Collection/WebScrape_Grid_Enity_Textbox'), 'Anderson CAD')

WebUI.sendKeys(findTestObject('7. Data Collection/Source/Webscrape_Entity_textbox'), Keys.chord(Keys.ENTER))

WebUI.verifyElementPresent(findTestObject('7. Data Collection/WebScrape_Grid_Record1'), 10)
