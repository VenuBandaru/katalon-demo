...
WebUI.click(findTestObject('7. Data Collection/SourceTemplat_AlterStgTables_button'))

WebUI.verifyElementPresent(findTestObject('7. Data Collection/ST_Alterbutton_Errormessage'), 10)
