...
WebUI.selectOptionByValue(findTestObject('7. Data Collection/LM_dd_LoadMap'), '12', false)
...
WebUI.waitForElementPresent(findTestObject('7. Data Collection/Editing_TableParam_Heading'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/StgTableName_Textbox'), 15)

WebUI.selectOptionByValue(findTestObject('7. Data Collection/StgTableName_Textbox'), 'stg_ga_wingap_pe_acc_ctrl', false)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/SourceType_Textbox'), 15)

WebUI.selectOptionByValue(findTestObject('7. Data Collection/SourceType_Textbox'), '13', false)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/RollStatus_Textbox'), 15)

WebUI.selectOptionByValue(findTestObject('7. Data Collection/RollStatus_Textbox'), '2', false)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/NotifyMissing_Textbox'), 15)

WebUI.selectOptionByValue(findTestObject('7. Data Collection/NotifyMissing_Textbox'), '1', false)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/OverrideMissing_Textbox'), 15)

WebUI.selectOptionByValue(findTestObject('7. Data Collection/OverrideMissing_Textbox'), '0', false)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/OverrideEmpty_Textbox'), 15)

WebUI.selectOptionByValue(findTestObject('7. Data Collection/OverrideEmpty_Textbox'), '0', false)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Editing_TableParam_btn_Close'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Editing_TableParam_btn_Submit'), 15)

WebUI.click(findTestObject('7. Data Collection/Editing_TableParam_btn_Submit'))

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Source/TableParam_Record3_Col1'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Source/TableParam_Record3_Col7_Delete'), 15)

WebUI.click(findTestObject('7. Data Collection/Source/TableParam_Record3_Col7_Delete'))
