...
WebUI.verifyElementPresent(findTestObject('7. Data Collection/Row1_Delete_Icon'), 10)

not_run: WebUI.verifyElementPresent(findTestObject('7. Data Collection/Label_VerifyEnabled'), 10)

not_run: WebUI.verifyElementClickable(findTestObject('7. Data Collection/Checkbox_VerifyEnabled'), FailureHandling.STOP_ON_FAILURE)
