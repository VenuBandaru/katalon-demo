...
WebUI.click(findTestObject('7. Data Collection/LM_dd_LoadMap'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.waitForElementPresent(findTestObject('7. Data Collection/btn_Plus'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/btn_plus_QuickAdd'), 15)

WebUI.click(findTestObject('7. Data Collection/btn_plus_QuickAdd'))

WebUI.waitForElementPresent(findTestObject('7. Data Collection/QuickAddTableParms'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Quickadd_Label_SourceType'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Quickadd_Label_RollStatus'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Quickadd_SourceType_textbox'), 15)

WebUI.selectOptionByValue(findTestObject('7. Data Collection/Quickadd_SourceType_textbox'), '17', false)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Quickadd_RollStatus_Textbox'), 15)

WebUI.selectOptionByValue(findTestObject('7. Data Collection/Quickadd_RollStatus_Textbox'), '1', false)
