...
WebUI.click(findTestObject('7. Data Collection/Sync_button'))

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Secheading_SyncLoadMap_SourceTemplateColumns'), 15)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/Msg_NothingToDo'), 15)
