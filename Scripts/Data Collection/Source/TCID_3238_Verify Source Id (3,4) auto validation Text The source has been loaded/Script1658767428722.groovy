...
WebUI.click(findTestObject('7. Data Collection/Source/Textbox_Year'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.selectOptionByValue(findTestObject('7. Data Collection/Source/Textbox_StateOptional'), '3', false)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/Textbox_SourceStatus'), 15)

WebUI.selectOptionByValue(findTestObject('7. Data Collection/Source/Textbox_SourceStatus'), '3', false)
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Source_GridFirstRow1_AZ'), 60)

WebUI.click(findTestObject('5. Data Tasks/Source_GridFirstRow1_AZ'))

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/Heading_SourceEdit'), 80)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/Subheading_Validation'), 30)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/Validation_loadedMessage'), 10)

WebUI.verifyElementText(findTestObject('7. Data Collection/Source/Validation_loadedMessage'), 'This source has not yet validated or loaded.')
