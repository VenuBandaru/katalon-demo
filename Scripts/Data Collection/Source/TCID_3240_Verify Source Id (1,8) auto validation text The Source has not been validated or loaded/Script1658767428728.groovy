...
WebUI.selectOptionByValue(findTestObject('7. Data Collection/Source/Textbox_StateOptional'), '42', false)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/Textbox_SourceStatus'), 15)

WebUI.selectOptionByValue(findTestObject('7. Data Collection/Source/Textbox_SourceStatus'), '1', false)
...
WebUI.selectOptionByValue(findTestObject('7. Data Collection/Source/Textbox_RollStatus'), '4', false)
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Source_GridFirstRow1_TN'), 60)

WebUI.click(findTestObject('5. Data Tasks/Source_GridFirstRow1_TN'))
