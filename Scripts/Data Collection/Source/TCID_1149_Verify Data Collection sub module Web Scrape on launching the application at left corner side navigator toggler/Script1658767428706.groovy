...
WebUI.waitForElementPresent(findTestObject('7. Data Collection/Sub_WebScrape'), 10)

WebUI.doubleClick(findTestObject('7. Data Collection/Sub_WebScrape'))

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Sec_WebscrapeList_Heading'), 20)
