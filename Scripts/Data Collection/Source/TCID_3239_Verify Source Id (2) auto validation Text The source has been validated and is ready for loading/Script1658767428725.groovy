...
WebUI.sendKeys(findTestObject('7. Data Collection/Source/Textbox_Year'), '2021')
...
WebUI.selectOptionByValue(findTestObject('7. Data Collection/Source/Textbox_StateOptional'), '33', false)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/Textbox_SourceStatus'), 15)

WebUI.selectOptionByValue(findTestObject('7. Data Collection/Source/Textbox_SourceStatus'), '2', false)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/Textbox_SourceTypes'), 10)

WebUI.selectOptionByValue(findTestObject('7. Data Collection/Source/Textbox_SourceTypes'), '1', false)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/label_RollStatus'), 10)

WebUI.selectOptionByValue(findTestObject('7. Data Collection/Source/Textbox_RollStatus'), '1', false)
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Source_GridFirstRow_NC'), 15)

WebUI.click(findTestObject('5. Data Tasks/Source_GridFirstRow_NC'))
...
WebUI.verifyElementText(findTestObject('7. Data Collection/Source/Validation_loadedMessage'), 'The source has been validated and is ready for loading.')

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/GreenTickMark'), 15)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/Staging_Message'), 10)

WebUI.verifyElementText(findTestObject('7. Data Collection/Source/Staging_Message'), 'This source was staged successfully.')

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Source/Staging_GreenTickMark'), 15)
