...
WebUI.doubleClick(findTestObject('7. Data Collection/Sub_WebParser'))

WebUI.verifyElementPresent(findTestObject('1. Login Page/PtxTech_Logo'), 10)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Sec_WebParserList_Heading'), 20)
