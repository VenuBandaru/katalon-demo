...
WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Grid_State'), 10)

WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Grid_Assessor'), 10)

WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Grid_County'), 10)

WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Grid_ProductType'), 10)

WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Grid_Filter'), 10)

WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Grid_Format'), 10)

WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Grid_Year'), 10)

WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Grid_RollStatus'), 10)

WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Grid_DateAdded'), 10)

WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Grid_FileIteration'), 10)

WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Grid_Download'), 10)

WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Grid_Notes'), 10)

WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Grid_Record1'), 10)
