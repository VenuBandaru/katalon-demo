...
not_run: WebUI.click(findTestObject('9. Dataset Setup/Sub_CustomerAssignment'))

WebUI.verifyElementPresent(findTestObject('9. Dataset Setup/Sub_CustomerAssignment'), 30)
