...
WebUI.sendKeys(findTestObject('5. Data Tasks/Year_Textbox'), 'e')
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/ErrorMessage_Year'), 10)

WebUI.sendKeys(findTestObject('5. Data Tasks/Year_Textbox'), Keys.chord(Keys.CONTROL, 'A'))

WebUI.sendKeys(findTestObject('5. Data Tasks/Year_Textbox'), '++--')
