...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_DateAvaliable'), '02/08/2022')
...
String Upload = userDir + '/Data Files/Tablename_Missing.zip'
...
WebUI.waitForElementPresent(findTestObject('5. Data Tasks/AutoVerfication_Unmapped_Juris_Code_Error'), 15)
...
WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Editlink_JurisCodeError'), 15)

WebUI.click(findTestObject('5. Data Tasks/Editlink_JurisCodeError'))

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Label_ErrorResolution'), 15)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/ErrorResoluiton_Message'), 15)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/ErrorResolution_btnCancel'), 15)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/ErrorResolution_btnOverride'), 15)
