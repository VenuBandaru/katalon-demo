...
not_run: WebUI.sendKeys(findTestObject('5. Data Tasks/TaskStatus_Textbox'), 'Child Task In Progress [RDDF]')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_UserName'), 'vbandaru_Test3')

WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_UserName'), Keys.chord(Keys.ENTER))

WebUI.selectOptionByLabel(findTestObject('5. Data Tasks/ChildTask_TaskStatus_Value'), TaskStatusValue, false)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/ChildTask_TaskStatus_Value'), 10)

not_run: WebUI.click(findTestObject('5. Data Tasks/ChildTask_TaskStatus_Value'))

WebUI.selectOptionByLabel(findTestObject('5. Data Tasks/ChildTask_TaskStatus_Value'), ChangeTaskStatus, false)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/popup_heading_Reason'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/popup_message_heading'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/popup_Reason_btn_Cancel'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/popup_Reason_btn_Submit'), 10)

WebUI.click(findTestObject('5. Data Tasks/popup_Reason_btn_Submit'))

WebUI.verifyElementClickable(findTestObject('5. Data Tasks/ChildTask_SaveAll'))
