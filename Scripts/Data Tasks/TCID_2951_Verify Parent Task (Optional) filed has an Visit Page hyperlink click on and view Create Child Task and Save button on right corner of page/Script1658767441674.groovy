...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/btn_ChildTaskSave_ParentTask'), 25)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/btn_CreateChild_PatentTask'), 25)
