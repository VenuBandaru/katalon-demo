...
WebUI.click(findTestObject('5. Data Tasks/States(Optional)_Textbox'))
...
WebUI.click(findTestObject('5. Data Tasks/Colleciton Method_Textbox'))
...
WebUI.click(findTestObject('5. Data Tasks/RequestType_Textbox'))
...
WebUI.click(findTestObject('5. Data Tasks/TaskStatus_Textbox'))
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Entity_Textbox_Value'), 25)

WebUI.click(findTestObject('5. Data Tasks/Entity_Textbox_Value'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('5. Data Tasks/Entity_Textbox_Value'), Keys.chord(Keys.CONTROL, 'A'))

WebUI.sendKeys(findTestObject('5. Data Tasks/Entity_Textbox_Value'), 'Hill CAD')
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/SourceTemplate_Value'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/LoadMaps_Value'), 10)

WebUI.verifyElementClickable(findTestObject('5. Data Tasks/SourceTemplate_Value'))

WebUI.verifyElementClickable(findTestObject('5. Data Tasks/LoadMaps_Value'))
