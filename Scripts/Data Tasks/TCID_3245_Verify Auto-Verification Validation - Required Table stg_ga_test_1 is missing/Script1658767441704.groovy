...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_DateAvaliable'), '02/12/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_Est_AppealDeadline'), '06/22/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_AssessorAppealDeadline'), '06/24/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_RequestSentDate'), '06/26/2022')
...
'Required Table stg_ga_test_1 is missing'
...
WebUI.waitForElementPresent(findTestObject('7. Data Collection/btn_ViewFullLog'), 15)
