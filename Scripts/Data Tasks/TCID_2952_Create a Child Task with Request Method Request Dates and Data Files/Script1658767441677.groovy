...
WebUI.waitForElementPresent(findTestObject('5. Data Tasks/ddl_RequestMethod'), 25)

WebUI.selectOptionByValue(findTestObject('5. Data Tasks/ddl_RequestMethod'), '11', false)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/CreateChild_btn_Submit'), 25)
