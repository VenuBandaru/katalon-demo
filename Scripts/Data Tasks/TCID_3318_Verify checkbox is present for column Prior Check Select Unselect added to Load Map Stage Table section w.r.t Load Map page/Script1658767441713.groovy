...
WebUI.verifyElementPresent(findTestObject('7. Data Collection/Row1_PriorCheck_Checkbox'), 15)

WebUI.verifyElementNotChecked(findTestObject('7. Data Collection/Row1_PriorCheck_Checkbox'), 15)
