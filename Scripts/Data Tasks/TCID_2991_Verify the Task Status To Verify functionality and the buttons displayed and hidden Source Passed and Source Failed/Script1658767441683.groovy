...
not_run: WebUI.sendKeys(findTestObject('5. Data Tasks/States(Optional)_Textbox'), 'Georgia')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/TaskStatus_Textbox'), 'To Verify [RDDF]')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Entity_Textbox_Value'), 'Anderson CAD')
...
WebUI.verifyElementNotPresent(findTestObject('5. Data Tasks/SourcePassed'), 15)

WebUI.verifyElementNotPresent(findTestObject('5. Data Tasks/SourceFailed'), 15)
