...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_ScheduleRequestDate'), '06/13/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_Est_NoticeDate'), '06/14/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_NoticeDate'), '06/16/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_Est_AppealDeadline'), '06/18/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_AssessorAppealDeadline'), '06/19/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_RequestSentDate'), '06/20/2022')
...
String Upload = userDir + '\\Data Files\\SourceLoading.zip'
...
not_run: WebUI.waitForElementPresent(findTestObject('5. Data Tasks/ReadyforLoading_msg'), 15)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/AutoVerfication_Unmapped_Juris_Code_Error'), 25)

WebUI.refresh()

WebUI.verifyElementText(findTestObject('5. Data Tasks/AutoVerfication_Unmapped_Juris_Code_Error'), 'Required Table stg_ga_test_1 is missing')

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/AutoVerification_Unmapped_Assessor_Code_Error'), 25)

WebUI.verifyElementText(findTestObject('5. Data Tasks/AutoVerification_Unmapped_Assessor_Code_Error'), 'Required Table stg_ga_test_2 is missing')
...
not_run: WebUI.verifyElementPresent(findTestObject('7. Data Collection/btn_ViewFullLog'), 25)
