...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_AssessorAppealDeadline'), '06/29/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_RequestSentDate'), '06/30/2022')
...
not_run: WebUI.verifyElementPresent(findTestObject('7. Data Collection/btn_ViewFullLog'), 10)

not_run: WebUI.click(findTestObject('7. Data Collection/btn_ViewFullLog'))
