...
WebUI.click(findTestObject('5. Data Tasks/TaskStatus_Textbox'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('5. Data Tasks/TaskStatus_Textbox'), Keys.chord(Keys.ENTER, 'A'))

WebUI.sendKeys(findTestObject('5. Data Tasks/TaskStatus_Textbox'), 'Correct Staging Errors [RDDF]')

WebUI.sendKeys(findTestObject('5. Data Tasks/TaskStatus_Textbox'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('5. Data Tasks/TaskStatus_Textbox'), FailureHandling.STOP_ON_FAILURE)

WebUI.sendKeys(findTestObject('5. Data Tasks/TaskStatus_Textbox'), 'Configure Source Template [RDDF]')
