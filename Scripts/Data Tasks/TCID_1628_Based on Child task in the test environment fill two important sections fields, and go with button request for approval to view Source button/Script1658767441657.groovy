...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_UserName'), 'vbandaru_test09')
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Textbox_Est_NoticeDate'), 10)
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Textbox_NoticeDate'), 10)
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Textbox_Est_AppealDeadline'), 10)
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Textbox_AssessorAppealDeadline'), 10)
...
WebUI.waitForElementVisible(findTestObject('5. Data Tasks/Textbox_RequestSentDate'), 30)

WebUI.refresh()

WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_RequestSentDate'), Keys.chord(Keys.CONTROL, 'A'))

WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_RequestSentDate'), '06/03/2022')
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/btn_NewSource'), 10)

WebUI.click(findTestObject('5. Data Tasks/btn_NewSource'))

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_Year'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_State'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_SourceType'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_SourceTemplate'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_SourceOrigin'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_SourceCreateDate'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_Secheading_Notes'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_RollStatus'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_RequestContent'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_County'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_DateAdded'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_Description'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_GoogleDriveLocation'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_GoogleFileName'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_Notemplate'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_CSN_OtherAssociatedTasks'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Checkbox_CSN_NoTemplate'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Checkbox_CSN_RemoveAll'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/hlink_CSN_Upload'), 10)
