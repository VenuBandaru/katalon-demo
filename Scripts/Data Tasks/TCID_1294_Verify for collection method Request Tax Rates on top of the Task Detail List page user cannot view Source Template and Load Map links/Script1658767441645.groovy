...
WebUI.sendKeys(findTestObject('5. Data Tasks/Colleciton Method_Textbox'), 'Request Tax Rates')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/RequestType_Textbox'), 'Tax Rates - Final')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/TaskStatus_Textbox'), 'Processing Complete [RTR]')
...
WebUI.click(findTestObject('5. Data Tasks/Entity_Searchbox'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementNotPresent(findTestObject('5. Data Tasks/SourceTemplate_Value'), 10)

WebUI.verifyElementNotPresent(findTestObject('5. Data Tasks/LoadMaps_Value'), 10)
