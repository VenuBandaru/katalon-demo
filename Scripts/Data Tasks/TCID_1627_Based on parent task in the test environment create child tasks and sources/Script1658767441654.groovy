...
WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Year_Textbox'), 10)
...
WebUI.waitForElementPresent(findTestObject('5. Data Tasks/States(Optional)_Textbox'), 10)
...
WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Colleciton Method_Textbox'), 15)
...
WebUI.verifyElementPresent(findTestObject('1. Login Page/PtxTech_Logo'), 15)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/Sec_LoadMap_Heading'), 15)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/RequestType_Textbox'), 15)
...
WebUI.waitForElementPresent(findTestObject('5. Data Tasks/TaskStatus_Textbox'), 30)
...
WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Entity_Searchbox'), 20)
...
WebUI.waitForElementVisible(findTestObject('5. Data Tasks/Jasper_CAD'), 30)
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Label_ParentTask_Optional'), 15)

WebUI.waitForElementClickable(findTestObject('5. Data Tasks/Parent_VisistPage'), 20)

WebUI.click(findTestObject('5. Data Tasks/Parent_VisistPage'))

//WebUI.waitForElementVisible(findTestObject('5. Data Tasks/Parent_VisistPage'), 15)
not_run: TestObject MyTestObject1 = WebUICommonHelper.findWebElement(findTestObject('Object Repository/5. Data Tasks/Parent_VisistPage'), 
    30)

not_run: WebUI.click(MyTestObject1)

//WebUI.waitForElementClickable(findTestObject('5. Data Tasks/Parent_VisistPage'), 10)
...
WebUI.click(findTestObject('5. Data Tasks/btn_CreateChild_PatentTask'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_UserName'), 'vbandaru_test')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_DateAvaliable'), '02/09/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_Est_NoticeDate'), '06/21/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_NoticeDate'), '06/23/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_Est_AppealDeadline'), '06/24/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_AssessorAppealDeadline'), '06/26/2022')
