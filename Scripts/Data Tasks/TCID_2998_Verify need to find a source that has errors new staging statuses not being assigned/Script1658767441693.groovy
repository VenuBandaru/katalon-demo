...
String Upload = userDir + '\\Data Files\\SourceInvalidfile.zip'
...
not_run: WebUI.waitForElementPresent(findTestObject('5. Data Tasks/MessageSymbol'), 25)

not_run: WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Staging_ErrorMessages'), 25)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Edit_ErrorMessage'), 25)

WebUI.click(findTestObject('5. Data Tasks/Edit_ErrorMessage'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Heading_Staging_ErrorMessage'), 25)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Heading_Staging_ErrorMessage'), 25)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/ErrorResolution_btnCancel'), 20)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/ErrorResolution_btn_Override'), 20)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/ErrorResolution_btn_Resolve'), 20)

WebUI.click(findTestObject('7. Data Collection/ErrorResolution_btn_Cancel'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Staging_downArrow'), 20)

WebUI.doubleClick(findTestObject('5. Data Tasks/Staging_downArrow'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Staging_ResolvedErrorResolution'), 20)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Staging_ResolvedErrorResolution'), 20)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Staging_Resolved_popup_message'), 20)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/ER_btn_Cancel'), 20)

WebUI.waitForElementPresent(findTestObject('7. Data Collection/ER_btn_ResolveAll'), 20)

WebUI.click(findTestObject('7. Data Collection/ER_btn_Cancel'))

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/href_DataTaskDetail'), 25)
...
WebUI.verifyOptionSelectedByValue(findTestObject('5. Data Tasks/dd_textbox_TaskStatus'), '163', false, 10)
