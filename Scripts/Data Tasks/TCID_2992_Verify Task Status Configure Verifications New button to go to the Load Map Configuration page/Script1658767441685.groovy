...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Year_Textbox'), 20)
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/States(Optional)_Textbox'), 20)
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Colleciton Method_Textbox'), 20)
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/RequestType_Textbox'), 20)
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Entity_Searchbox'), 20)
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Entity_Textbox_Value'), 'Orange CAD')
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/DataTaskDetail_Heading'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/DTD_btn_Save'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/DTD_btn_LoadMapConfig'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/DTD_btn_Source'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/DTD_btn_CreateChildTask'), 10)

WebUI.click(findTestObject('5. Data Tasks/DTD_btn_LoadMapConfig'))

WebUI.switchToWindowIndex(1)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/LMC_Secheading_LoadMap'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/LMC_Label_State'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/LMC_Label_LoadMap'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/LMC_btn_Submit'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/LMC_btn_SaveAll'), 10)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/LMC_btn_AddNewLoadMap'), 10)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/LM_dd_State'), 10)

WebUI.verifyElementPresent(findTestObject('7. Data Collection/LM_dd_LoadMap'), 10)
