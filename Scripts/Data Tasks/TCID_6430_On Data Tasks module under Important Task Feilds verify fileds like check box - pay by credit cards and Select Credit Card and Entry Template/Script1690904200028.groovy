...
WebUI.click(findTestObject('5. Data Tasks/parent_Troup_County'))
...
WebUI.verifyElementPresent(findTestObject('5. Data Tasks/label_Payby_CreditCard'), 25)

WebUI.verifyElementText(findTestObject('5. Data Tasks/label_Payby_CreditCard'), 'Pay by Credit Card')

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Checkbox_payby_CreditCard'), 25)

WebUI.verifyElementNotClickable(findTestObject('5. Data Tasks/CreditCard_dropdown'))

WebUI.click(findTestObject('5. Data Tasks/Checkbox_payby_CreditCard'))

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/CreditCard_dropdown'), 25)

WebUI.selectOptionByLabel(findTestObject('5. Data Tasks/CreditCard_dropdown'), 'VISA', false)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/Label_EntryTemplate'), 25)

WebUI.verifyElementText(findTestObject('5. Data Tasks/Label_EntryTemplate'), 'Entry Template')

WebUI.selectOptionByLabel(findTestObject('5. Data Tasks/EntryTemplate_dropdown'), 'ZZZ-Image Only - Tax Asmt Default', false)

WebUI.click(findTestObject('5. Data Tasks/btn_Save'))
