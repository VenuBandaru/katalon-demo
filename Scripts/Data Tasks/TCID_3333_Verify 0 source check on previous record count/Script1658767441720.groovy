...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_DateAvaliable'), '02/02/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_Nextfollowupdate'), '06/08/2022')
...
String Upload = userDir + '/Data Files/AutoVerification_CustomChecks.zip'
...
WebUI.waitForElementPresent(findTestObject('5. Data Tasks/SecHeading_Validation'), 25)

WebUI.refresh()

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/AutoVerfication_Unmapped_Juris_Code_Error'), 35)
...
WebUI.waitForElementPresent(findTestObject('5. Data Tasks/AutoVerification_Unmapped_Assessor_Code_Error'), 35)
