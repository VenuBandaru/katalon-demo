...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_DateAvaliable'), '02/15/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_Nextfollowupdate'), '06/23/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_ScheduleRequestDate'), '06/26/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_Est_NoticeDate'), '06/26/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_NoticeDate'), '06/27/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_Est_AppealDeadline'), '06/28/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_AssessorAppealDeadline'), '06/25/2022')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_RequestSentDate'), '06/27/2022')
...
String Upload = userDir + '/Data Files/AutoValidation_UniqueCheck.zip'
...
WebUI.verifyElementText(findTestObject('5. Data Tasks/AutoVerfication_Unmapped_Juris_Code_Error'), 'Table stg_ga_test_1 has Column(s) parcel_id, year with Duplicates')

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/AutoVerification_Unmapped_Assessor_Code_Error'), 25)

WebUI.refresh()

WebUI.verifyElementText(findTestObject('5. Data Tasks/AutoVerification_Unmapped_Assessor_Code_Error'), 'There are unmapped jurisdiction codes in this source')

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/AutoVerification_CustomCheck_Message'), 25)

WebUI.verifyElementText(findTestObject('5. Data Tasks/AutoVerification_CustomCheck_Message'), 'There are unmapped assessor codes in this source')
...
WebUI.selectOptionByValue(findTestObject('5. Data Tasks/dd_textbox_TaskStatus'), ManuallyVerify, false)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/btn_Save'), 12)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/SourcePassed'), 12)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/SourceFailed'), 12)

WebUI.verifyElementPresent(findTestObject('5. Data Tasks/button_Source'), 12)

WebUI.click(findTestObject('5. Data Tasks/SourceFailed'))

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/heading_FailedSource'), 10)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Label_Reason'), 10)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Description_textarea'), 10)

WebUI.sendKeys(findTestObject('5. Data Tasks/Description_textarea'), Keys.chord(Keys.CONTROL, 'A'))

WebUI.sendKeys(findTestObject('5. Data Tasks/Description_textarea'), 'Testing Failed Source')

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/FailedSource_btn_Close'), 10)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/FailedSource_btn_ReplaceSource'), 10)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/FailedSource_btn_AddToSource'), 10)

WebUI.click(findTestObject('5. Data Tasks/FailedSource_btn_ReplaceSource'))

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Label_AdditionalDataCost'), 10)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Textbox_AdditionalDataCost'), 10)

WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_AdditionalDataCost'), Keys.chord(Keys.ENTER, 'A'))

WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_AdditionalDataCost'), '0')

WebUI.sendKeys(findTestObject('5. Data Tasks/Textbox_AdditionalDataCost'), Keys.chord(Keys.ENTER))

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/Textbox_AdditionalDataCost'), 10)

WebUI.waitForElementPresent(findTestObject('5. Data Tasks/ManullyVerify_btn_NewSource'), 15)

WebUI.click(findTestObject('5. Data Tasks/ManullyVerify_btn_NewSource'))
...
String Uploadnew = userDirnew + '/Data Files/SourceValidfile.zip'

WebUI.uploadFile(findTestObject('5. Data Tasks/Browse_upload'), Uploadnew)
...
not_run: WebUI.waitForElementPresent(findTestObject('5. Data Tasks/AutoVerfication_Unmapped_Juris_Code_Error'), 25)
