...
WebUI.sendKeys(findTestObject('5. Data Tasks/Colleciton Method_Textbox'), 'Web Scrape')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/RequestType_Textbox'), 'Tax Roll - Final')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/TaskStatus_Textbox'), 'Processing Complete [WS]')
...
WebUI.sendKeys(findTestObject('5. Data Tasks/Entity_Textbox_Value'), 'Cotulla ISD')
